...
fig, ax = plt.subplots(7,2,figsize=(4,8))    
...
for i in range(par.tlen-1): 
    ...
    ax[0,0].plot(par.x/par.rp,par.T[i,:]) 
    ax[1,0].plot(par.x/par.rp,par.Ts[i,:]) 
    ax[2,0].plot(par.x/par.rp,par.p[i,:]) 
    ax[3,0].plot(par.x/par.rp,par.ps[i,:]) 
    ax[4,0].plot(par.x/par.rp,par.u[i,:])
    ax[5,0].plot(par.x/par.rp,par.delta[i,:])
    ax[6,0].plot(par.x/par.rp,par.xidot[i,:])

    ax[0,1].plot(par.x/par.rp,par.T[i+1,:]) 
    ax[1,1].plot(par.x/par.rp,par.Ts[i+1,:]) 
    ax[2,1].plot(par.x/par.rp,par.p[i+1,:]) 
    ax[3,1].plot(par.x/par.rp,par.ps[i+1,:]) 
    ax[4,1].plot(par.x/par.rp,par.u[i+1,:])
    ax[5,1].plot(par.x/par.rp,par.delta[i+1,:])
    ax[6,1].plot(par.x/par.rp,par.xidot[i+1,:])
for c in range(0,2):    
    ax[0,c].set_xlabel('T')
    ax[1,c].set_xlabel('Ts')
    ax[2,c].set_xlabel('p')
    ax[3,c].set_xlabel('ps')
    ax[4,c].set_xlabel('u')
    ax[5,c].set_xlabel('delta')
    ax[6,c].set_xlabel('xidot')
plt.tight_layout()
plt.show()
